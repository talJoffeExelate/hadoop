 ...
 */
public class S3GuardCommitterFactory extends PathOutputCommitterFactory {
  public static final Logger LOG = LoggerFactory.getLogger(
      S3GuardCommitterFactory.class);
  ...
  public PathOutputCommitter createOutputCommitter(Path outputPath,
    ...
    if (fs instanceof S3AFileSystem) {
      outputCommitter = new S3GuardCommitter(outputPath, context);
    } else {
